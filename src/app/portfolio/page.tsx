...
const projects = [
  // 회사 프로젝트
  {
    ...
    technologies: ['Next.js 14', 'React 18', 'TypeScript', 'Material-UI', 'Zustand'],
    image: '🛒',
  ...
  },
  {
    ...
    technologies: ['Next.js 14', 'React 18', 'TypeScript', 'Material-UI', 'Zustand', 'Google Maps API'],
    image: '🗺️',
    github: 'https://github.com/MGflow',
  ...
  // 개인 프로젝트
  {
    title: 'MGsFlow 방명록 관리 대시보드',
    description: '방명록 시스템을 위한 관리자 대시보드입니다. 사이버펑크 테마의 현대적인 UI로 방명록 데이터를 분석하고 관리할 수 있습니다. Next.js 15와 TypeScript를 기반으로 구축되었으며, Material-UI와 Framer Motion을 활용한 인터랙티브한 사용자 경험을 제공합니다.',
    technologies: ['Next.js 15', 'TypeScript', 'Material-UI', 'Zustand', 'Framer Motion', 'CSS Modules'],
    image: '📊',
    github: 'https://github.com/MGsFlow/NextJS-Admin',
    live: 'https://mgsflow-next-js-admin.vercel.app',
    achievements: [
      '사이버펑크 테마의 현대적인 UI/UX 구현',
      '방명록 통계 분석 및 데이터 시각화',
      '반응형 디자인으로 모바일/데스크톱 최적화',
      'Material-UI와 Framer Motion을 활용한 인터랙티브 애니메이션',
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              <Work sx={{ color: '#FFB3BA' }} />
              회사 프로젝트
            </Typography>

            <Grid container spacing={4} sx={{ mb: 6 }}>
              {projects.filter(project => project.type === 'company').map((project, index) => (
                          ...
                          {project.achievements.map((achievement, achievementIndex) => (
                            <Grid item xs={12} md={6} key={achievementIndex}>
                              <Typography
                                ...
                                sx={{ display: 'flex', alignItems: 'center', mb: 1 }}
                              >
                                <TrendingUp sx={{ fontSize: 16, mr: 1, color: '#B3D9FF' }} />
                                {achievement}
                              </Typography>
                            </Grid>
                          ))}
